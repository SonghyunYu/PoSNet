...
class DIDN_middle(nn.Module):
    def __init__(self, in_channels):
        super(DIDN_middle, self).__init__()
        ch = 64
        ...
        #self.recursive_C = _Residual_Block(ch)
        #self.recursive_D = _Residual_Block(ch)
        ...
        self.conv_output = nn.Conv2d(in_channels=int(1.25*ch), out_channels=3, kernel_size=3, stride=1, padding=1, bias=False)
